...
let valor = randomObject.them.speed.past.program.grade.addition.whose.national.cannot.board
console.log(`clave: board , valor : ${valor}`)

let input = window.prompt("Escribe un nombre: ")
